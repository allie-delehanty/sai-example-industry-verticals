          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="bg-background ring-border text-foreground placeholder:text-foreground-muted focus:ring-foreground h-12 w-full rounded-full ps-5 pe-32 ring-1 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="bg-foreground group-[.container-dark-background]:bg-accent group-[.container-dark-background]:!text-foreground text-background absolute top-1/2 right-2 h-9 -translate-y-1/2 rounded-full px-5 text-sm font-semibold hover:opacity-90 focus-visible:ring-2 focus-visible:outline-none md:right-3 md:h-10 md:px-6"
              >
      ...
      <div className="max-w-sm">
        ...
        <form className="w-full" action="">
          ...
          <input
            ...
            className="bg-background text-foreground placeholder:text-foreground-muted ring-border focus:ring-foreground h-12 w-full rounded-full ps-5 pe-5 ring-1 focus:ring-2 focus:outline-none md:h-14"
          />

          <button
            type="submit"
            className="bg-foreground group-[.container-dark-background]:bg-accent text-background group-[.container-dark-background]:!text-foreground mt-3 inline-flex h-12 w-full items-center justify-center rounded-full font-semibold tracking-wide hover:opacity-90 md:h-12"
          >
            {t('button_text') || 'Subscribe'}
          </button>
