...
import { Default as HeroBanner, TopContent, Editorial } from '../components/hero-banner/HeroBanner';
...
const createHeroBannerFields = () => ({
  Image: {
    value: {
      src: 'https://placehold.co/1920x1080/492687/FFFFFF?text=Hero+Img',
  ...
  Title: createTextField('When Experience Matters Choose VITAS'),
  Description: createRichTextField(1),
  CtaLink: createLinkField('Refer a Patient'),
});
...
export const WithEditorial: Story = {
  render: (args) => {
    const params = {
      ...baseParams,
      styles: clsx(
    ...
    return <Editorial params={params} rendering={baseRendering} fields={fields} />;
  },
};
